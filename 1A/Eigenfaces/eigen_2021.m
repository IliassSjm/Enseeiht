...
switch v
    ...
    case 0
        ...
        % appel à subspace iteration : calcul des m premières valeurs propres
        t_v0 =  cputime;
        % W valeurs propres
        % V vecteurs propres
        ...
        if(flag0 == 0)
            ...
            fprintf('\nTemps subpace iteration = %0.3e\n',t_v0);            
            fprintf('Nombre d''itérations de la méthode = %d\n', it0);
            ...
            save("iter_v0", 'V0', 'W0', 'q0', 'qv0', "t_v0");
                       
            W = W0;
            V = V0;
        else
            fprintf('subspace iteration : convergence non atteinte : %d\n', it0);            
            W = 0;
            V = 0;
        end
        flag = flag0;
